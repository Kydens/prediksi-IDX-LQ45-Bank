...
<link rel="stylesheet" type="text/css" href="{{ asset('css/font500.css') }}">
<div class="container">
    <div class="error">
        <h1>503</h1>
        <h2>error</h2>
        <p>Oops, sepertinya terdapat kesalahan &#128532;</p>
    ...
    <footer>
        <p class="copyright">©2024 Eddy Nathansyah</p>
    </footer>
</div>
<style>
    footer {
...
<script type="text/javascript" src="{{ asset('js/script500.js') }}"></script>
